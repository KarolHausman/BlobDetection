...
void BlobDetector::buildGaussianPyramid(const cv::Mat& input_image, std::vector< cv::Mat >& pyramid, cv::Mat& smallest_level, const int& levels)
{
    pyramid.clear();
...
void BlobDetector::buildLaplacianPyramid(const cv::Mat& input_image, std::vector<cv::Mat>& pyramid, cv::Mat& smallest_level, const int& levels)
{
